...
/**
 * Created by nwd3 on 4/28/2017.
 */
@Entity
public class Person {
    //@Id @GeneratedValue(generator = "cpdbSequence")
   // @SequenceGenerator(name = "cpdbSequence", sequenceName = "cpdb_sequence", allocationSize = 1)
    ...
    private Collection<Team> teambyPersonID;
    private long[] mylist;
...
public  void setHID(long hid){
   ...
   // setPersonsById(hid);
    ...
    public void setPersonsById(Household householdid) {
        this.householdByHouseholdid = householdid;
    }
    @ManyToMany
    ...
    public void setTeam(Collection<Team> t){
        this.teambyPersonID=t;
    }
